...
var AboutComponent = (function () {
    ...
    function AboutComponent() {
        ...
        console.log("getFoo in about", getFoo, "parsed", JSON.parse(getFoo));
        var fnol = JSON.parse(getFoo);
        this.incidentCity = fnol.incidentCity;
        this.incidentState = fnol.incidentState;
        this.incidentZipCode = fnol.incidentZipCode;
        this.incidentPoliceRpt = fnol.incidentPoliceRpt;
        this.insuranceName = fnol.insuranceName;
        this.insuranceAddress = fnol.insuranceAddress;
        this.damageDescription = fnol.damageDescription;
        this.damageSeverity = fnol.damageSeverity;
        this.partyName = fnol.partyName;
        this.partyAddress = fnol.partyAddress;
        this.partyContact = fnol.partyContact;
        this.partyDamageDescription = fnol.partyDamageDescription;
        this.drivableCarInd = fnol.drivableCarInd;
        this.partyLicensePlate = fnol.partyLicensePlate;
        this.policyNumber = fnol.policyNumber;
    ...
    AboutComponent.prototype.updateClaim = function () {
        ...
        var foo = JSON.stringify(this._newClaim);
        ...
        /* this.postsService.updateClaimDetails(this._newClaim).subscribe(
                 function(response) {
...
var UserComponent = (function () {
    ...
    UserComponent.prototype.createClaim = function (fnol) {
        this.loadingNewClaim = true;
        this.successClaim = true;
        var foo = JSON.stringify(fnol);
        localStorage.setItem('fnol', foo);
        var getFoo = localStorage.getItem("fnol");
        ...
        this.router.navigate(['claimAck', fnol]);
        // }
        // );
    };
